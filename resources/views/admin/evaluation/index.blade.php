    ...
    <x-slot name="header">
        <div class=" bg-white border border-light shadow-card rounded-lg py-4 px-4 sm:px-6 md:px-8 md:py-1 ">
            <ul class="flex items-center">
                <li class="flex items-center"> <a href="{{ route('evaladmin') }}"
        ...
        <div class="row">
            <div class="col-md-12 p-3">
                <header class="px-5 py-4 border-b border-gray-100">
                    <div class="font-semibold text-xl text-gray-800 leading-tight">Les Plannings anneul de formation</div>
                </header>
                @if (session('success'))
                            ...
                            <table id="example2"
                                ...
                                <tbody class="divide-y divide-gray-100 border-t border-gray-100">
                                    ...
                                    <tr class="hover:bg-gray-50">
                                        <td class="px-6 py-4">Planning N°{{ $count }}</td>
                                        <td class="px-6 py-4">
                                        ...
                                        <td class="px-6 py-4">
                                            <div class="flex justify-end gap-4">
                                                <a href="{{ route('evaladmin.show', ['id' => $planning->id]) }}" class="px-2 py-1"><svg
