        ...
        <div class="row">
            <div class="col-md-12 p-2">
                <header class="px-4 py-4 border-b border-gray-100">
                    <div class="font-semibold text-xl text-gray-800 leading-tight">Les plannings annuel de formation</div>
                </header>
                @if (session('success'))
                                        ...
                                        <tr class="hover:bg-gray-50">
                                            ...
                                            <td class="px-6 py-4">
                                                <div class="flex justify-end gap-4">
                                                    <a href="{{ route('planning.show', ['id' => $planning->id]) }}" class="px-2 py-1"><svg
