        ...
        <div class="row">
            <div class="col-md-12 p-5">
                ...
                <header class="px-5 py-4 border-b border-gray-100">
                    <div class="font-semibold text-xl text-gray-800 leading-tight">Liste de formations non évaluées
                    </div>
                </header>
                                        ...
                                        <tr class="hover:bg-gray-50">
                                            ...
                                            <td class="px-6 py-4">
                                                <div class="flex flex-row justify-end">
                                                    <a href="{{ route('evaluer.show',  ['id' => $formation->id ,'id2' => $employee->id ]) }}"
                ...
                <header class="px-5 py-4 border-b border-gray-100">
                    <div class="font-semibold text-xl text-gray-800 leading-tight">Liste de formations évaluées</div>
                </header>
                <div class="bg-white overflow-hidden rounded-lg mr">
                    <div class="shadow-xs rounded-lg overflow-hidden w-full">
                        <div class="overflow-x-auto w-full p-4">
                                ...
                                <tbody class="divide-y divide-gray-100 border-t border-gray-100">
                                    ...
                                    @foreach ($formations2 as $formation)
                                                <tr class="hover:bg-gray-50">
                                                    ...
                                                    <td class="px-6 py-4">
                                                        <div class="flex flex-row justify-end">
                                                            <a href="{{ route('apresEvaluer.show', ['id'=> $formation->id] ) }}"
                                                                class="px-2 py-1 text-gray-700 hover:text-gray-900">
