...
<a href="{{ route('demandes') }}" class="flex items-center space-x-1 rounded-md px-2 py-3 hover:bg-gray-100 hover:text-blue-600">
    <span class="text-2xl"><i class="bx bx-file"></i></span>
    <span>Besoins</span>
</a>

<a href="{{ route('evaluationFroid') }}" class="flex items-center space-x-1 rounded-md px-2 py-3 hover:bg-gray-100 hover:text-blue-600">
