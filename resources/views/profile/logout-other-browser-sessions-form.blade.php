<x-action-section>
    ...
    <x-slot name="content">
        ...
        <x-dialog-modal wire:model="confirmingLogout">
            <x-slot name="title">
                {{ __('Déconnexion des autres sessions de navigateur') }}
            </x-slot>

            <x-slot name="content">
                {{ __('Veuillez entrer votre mot de passe pour confirmer que vous souhaitez vous déconnecter des autres sessions de navigateur sur tous vos appareils.') }}
